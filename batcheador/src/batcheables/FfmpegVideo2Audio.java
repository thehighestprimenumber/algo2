...
public class FfmpegVideo2Audio implements Ibatcheable {
	@Parameter(flag = "-i", label = "Image Input", control = "gui.FileChooserOpenControl", optional = false)
	public String imageInput;

	@Parameter(flag = "-i", label = "Audio Input", control = "gui.FileChooserOpenControl", optional = false)
